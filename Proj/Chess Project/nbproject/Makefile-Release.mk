...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cis17a_final_v6.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cis17a_final_v6.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cis17a_final_v6 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/ChessPiece.o: ChessPiece.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ChessPiece.o ChessPiece.cpp
